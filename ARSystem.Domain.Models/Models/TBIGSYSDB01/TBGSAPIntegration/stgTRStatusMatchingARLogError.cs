...
{
	public class stgTRStatusMatchingARLogError : BaseClass
	{
		public stgTRStatusMatchingARLogError()
		{
			this.ErrorType = 0;
			this.ErrorMessage = null;
		}
		public stgTRStatusMatchingARLogError(int errorType, string errorMessage)
		{
