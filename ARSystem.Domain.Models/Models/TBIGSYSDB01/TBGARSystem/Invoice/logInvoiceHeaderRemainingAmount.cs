...
{
	public class logInvoiceHeaderRemainingAmount : BaseClass
	{
		public logInvoiceHeaderRemainingAmount()
		{
			this.ErrorType = 0;
			this.ErrorMessage = null;
		}
		public logInvoiceHeaderRemainingAmount(int errorType, string errorMessage)
		{
			this.ErrorType = errorType;
			this.ErrorMessage = errorMessage;
		}
		public int trxInvoiceHeaderLogRemainingAmountID { get; set; }
		...
		public int? trxInvoiceHeaderRemainingAmountParentId { get; set; }
