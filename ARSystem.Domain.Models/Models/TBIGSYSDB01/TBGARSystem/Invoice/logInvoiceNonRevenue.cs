...
{
	public class logInvoiceNonRevenue : BaseClass
	{
		public logInvoiceNonRevenue()
		{
			this.ErrorType = 0;
			this.ErrorMessage = null;
		}
		public logInvoiceNonRevenue(int errorType, string errorMessage)
		{
			this.ErrorType = errorType;
			this.ErrorMessage = errorMessage;
		}
		public int trxInvoiceNonRevenueLogID { get; set; }
