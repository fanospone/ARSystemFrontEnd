...
{
	public class trxInvoiceHeaderRemainingAmount : BaseClass
	{
		public trxInvoiceHeaderRemainingAmount()
		{
			this.ErrorType = 0;
			this.ErrorMessage = null;
		}
		public trxInvoiceHeaderRemainingAmount(int errorType, string errorMessage)
		{
