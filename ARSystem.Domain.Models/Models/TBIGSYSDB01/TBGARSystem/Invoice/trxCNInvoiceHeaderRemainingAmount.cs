...
{
	public class trxCNInvoiceHeaderRemainingAmount : BaseClass
	{
		public trxCNInvoiceHeaderRemainingAmount()
		{
			this.ErrorType = 0;
			this.ErrorMessage = null;
		}
		public trxCNInvoiceHeaderRemainingAmount(int errorType, string errorMessage)
		{
		...
		public int? trxCNInvoiceHeaderRemainingAmountParentId { get; set; }
