...
{
	public class logInvoiceTowerDetail : BaseClass
	{
		public logInvoiceTowerDetail()
		{
			this.ErrorType = 0;
			this.ErrorMessage = null;
		}
		public logInvoiceTowerDetail(int errorType, string errorMessage)
		{
			this.ErrorType = errorType;
			this.ErrorMessage = errorMessage;
		}
		public int trxInvoiceTowerDetailLogId { get; set; }
