...
{
	public class logInvoiceHeader : BaseClass
	{
		public logInvoiceHeader()
		{
			this.ErrorType = 0;
			this.ErrorMessage = null;
		}
		public logInvoiceHeader(int errorType, string errorMessage)
		{
			this.ErrorType = errorType;
			this.ErrorMessage = errorMessage;
		}
		public int trxInvoiceHeaderLogID { get; set; }
