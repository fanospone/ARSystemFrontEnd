...
{
	public class trxCNInvoiceTowerDetailRemaningAmount : BaseClass
	{
		public trxCNInvoiceTowerDetailRemaningAmount()
		{
			this.ErrorType = 0;
			this.ErrorMessage = null;
		}
		public trxCNInvoiceTowerDetailRemaningAmount(int errorType, string errorMessage)
		{
			this.ErrorType = errorType;
			this.ErrorMessage = errorMessage;
		}
		public int trxCNInvoiceTowerDetailRemaningAmountId { get; set; }
		public int trxCNInvoiceHeaderRemainingID { get; set; }
