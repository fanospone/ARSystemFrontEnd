...
{
	public class logInvoiceTowerDetailRemainingAmount : BaseClass
	{
		public logInvoiceTowerDetailRemainingAmount()
		{
			this.ErrorType = 0;
			this.ErrorMessage = null;
		}
		public logInvoiceTowerDetailRemainingAmount(int errorType, string errorMessage)
		{
			this.ErrorType = errorType;
			this.ErrorMessage = errorMessage;
		}
		public int trxInvoiceTowerDetailLogRemainingAmountId { get; set; }
