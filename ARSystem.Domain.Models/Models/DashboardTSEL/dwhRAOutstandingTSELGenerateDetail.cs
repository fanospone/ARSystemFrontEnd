...
{
	public class dwhRAOutstandingTSELGenerateDetail : BaseClass
	{
		public dwhRAOutstandingTSELGenerateDetail()
		{
			this.ErrorType = 0;
			this.ErrorMessage = null;
		}
		public dwhRAOutstandingTSELGenerateDetail(int errorType, string errorMessage)
		{
		...
		public string YearInvoiceCategory { get; set; }
