...
{
	public class vwBAPSData : BaseClass
	{
		public vwBAPSData()
		{
			this.ErrorType = 0;
		...
		public vwBAPSData(int errorType, string errorMessage)
		{
