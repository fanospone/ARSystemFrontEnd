...
{
	public class vwtrxUploadDataAccrueStaging : BaseClass
	{
		public vwtrxUploadDataAccrueStaging()
		{
			this.ErrorType = 0;
			this.ErrorMessage = null;
		}
		public vwtrxUploadDataAccrueStaging(int errorType, string errorMessage)
		{
