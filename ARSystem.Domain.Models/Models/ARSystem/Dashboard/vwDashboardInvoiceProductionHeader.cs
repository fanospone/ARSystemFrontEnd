...
{
	public class vwDashboardInvoiceProductionHeader : BaseClass
	{
		public vwDashboardInvoiceProductionHeader()
		{
			this.ErrorType = 0;
			this.ErrorMessage = null;
		}
		public vwDashboardInvoiceProductionHeader(int errorType, string errorMessage)
		{
