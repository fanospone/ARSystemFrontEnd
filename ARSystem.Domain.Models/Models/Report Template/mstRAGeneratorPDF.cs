...
{
	public class mstRAGeneratorPDF : BaseClass
	{
		public mstRAGeneratorPDF()
		{
			this.ErrorType = 0;
			this.ErrorMessage = null;
		}
		public mstRAGeneratorPDF(int errorType, string errorMessage)
		{
        ...
        public string LogoLeftYpos { get; set; }
