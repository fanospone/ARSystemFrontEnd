...
{
	public class vwRANewCheckingDocumentBAUK : BaseClass
	{
		public vwRANewCheckingDocumentBAUK()
		{
			this.ErrorType = 0;
			this.ErrorMessage = null;
		}
		public vwRANewCheckingDocumentBAUK(int errorType, string errorMessage)
		{
		...
		public int? BAPSActivityID { get; set; }
