...
var Table = {
    ...
    Search: function () {
        ...
        var tblSummaryData = $("#tblSummaryData").DataTable({
            ...
            "ajax": {
                "url": "/api/ARProcessInvoiceTower/gridHistory",
                "type": "POST",
                "datatype": "json",
                "data": params,
            },
    ...
    Export: function () {
        var href = "/InvoiceTransaction/TrxARProcessInvoiceTowerHistory/Export?invOperatorId=" + fsInvOperatorId + "&invoiceTypeId=" + fsInvoiceTypeId +
