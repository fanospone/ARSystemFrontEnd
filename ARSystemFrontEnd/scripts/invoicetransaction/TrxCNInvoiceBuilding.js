...
var Table = {
    ...
    Search: function () {
        ...
        var tblSummaryData = $("#tblSummaryData").DataTable({
            ...
            "ajax": {
                "url": "/api/CNInvoiceBuilding/grid",
                "type": "POST",
                "datatype": "json",
                "data": params,
            },
    ...
    Export: function () {
        var href = "/InvoiceTransaction/TrxCNInvoiceBuilding/Export?companyName=" + fsCustomerName + "&invoiceTypeId=" + fsInvoiceTypeId + "&invCompanyId=" + fsInvCompanyId + "&invNo=" + fsInvNo;
...
var InvoiceBuilding = {
    CNSPV: function () {
        ...
        $.ajax({
            url: "/api/CNInvoiceBuilding/CNSPV",
            type: "POST",
            dataType: "json",
    ...
    CNDeptHead: function () {
        ...
        $.ajax({
            url: "/api/CNInvoiceBuilding/CNDeptHead",
            type: "POST",
            dataType: "json",
            contentType: "application/json",
            data: JSON.stringify(params),
