...
var Table = {
    ...
    Search: function () {
        ...
        var tblSummaryData = $("#tblSummaryData").DataTable({
            ...
            "ajax": {
                "url": "/api/ARProcessInvoiceBuilding/grid",
                "type": "POST",
                "datatype": "json",
                "data": params,
            },
    ...
    Export: function () {
        var href = "/InvoiceTransaction/TrxARProcessInvoiceBuilding/Export?customerName=" + fsCustomerName + "&invoiceTypeId=" + fsInvoiceTypeId + "&invCompanyId=" + fsInvCompanyId + "&invNo=" + fsInvNo + "&StatusReceipt=" + fsIsReceipt;;
...
var InvoiceBuilding = {
    SavePICAARCollection: function () {
        var params = {
            trxPICAARID: Data.Selected.trxCNPICAARID,
        ...
        $.ajax({
            url: "/api/ARProcessInvoiceBuilding/PICA",
            type: "POST",
            dataType: "json",
            ...
            if (Common.CheckError.Object(data)) {
                ...
                //Table.Reset();
                $("#btPrint").attr("href", "/InvoiceTransaction/TrxPrintCNInvoiceBuilding/Print?trxCNInvoiceHeaderID=" + data.trxInvoiceHeaderID + "&isApproved=0");
                FormPICA.Done();
            }
            l.stop()
        })
    ...
    SaveARReceipt: function () {
        ...
        $.ajax({
            url: "/api/ARProcessInvoiceBuilding/Receipt",
            type: "POST",
            dataType: "json",
            contentType: false,
            data: formData,
