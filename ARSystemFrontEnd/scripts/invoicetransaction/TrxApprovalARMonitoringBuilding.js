...
jQuery(document).ready(function () {
    ...
    $("#btYesReOpenToPayment").unbind().click(function (e) {
        var isRemarkValid = $("#tbRemarks").parsley().validate();
        if (isRemarkValid)
            Process.ReOpenToPayment(Data.Selected.trxInvoiceHeaderID);
        e.preventDefault();
    });
});
...
var Table = {
    ...
    Search: function () {
        ...
        var tblSummaryData = $("#tblSummaryData").DataTable({
            ...
            "ajax": {
                "url": "/api/ApprovalARMonitoringBuilding/grid",
                "type": "POST",
                "datatype": "json",
                "data": params,
            },
            ...
            "columns": [
                {
                    ...
                    mRender: function (data, type, full) {
                        ...
                        if (Helper.IsElementExistsInArray(parseInt(full.trxInvoiceHeaderID), parseInt(full.mstInvoiceCategoryId), parseInt(full.BatchNumber), Data.RowSelected)) {
                            ...
                            strReturn += "<label id='" + full.mstInvoiceCategoryId + "-" + full.trxInvoiceHeaderID + "-" + full.BatchNumber + "' class='mt-checkbox mt-checkbox-single mt-checkbox-outline " + full.mstInvoiceCategoryId + "-" + full.trxInvoiceHeaderID + "-" + full.BatchNumber + "'><input type='checkbox' checked class='checkboxes' /><span></span></label>";
                        }
                        else {
                            strReturn += "<label id='" + full.mstInvoiceCategoryId + "-" + full.trxInvoiceHeaderID + "-" + full.BatchNumber + "' class='mt-checkbox mt-checkbox-single mt-checkbox-outline " + full.mstInvoiceCategoryId + "-" + full.trxInvoiceHeaderID + "-" + full.BatchNumber + "'><input type='checkbox' class='checkboxes' /><span></span></label>";
                        }
                        return strReturn;
                    }
                },
    ...
    Export: function () {
        ...
        window.location.href = "/InvoiceTransaction/TrxApprovalARMonitoringBuildingInvoice/Export?strStartPeriod=" + strStartPeriod + "&strEndPeriod=" + strEndPeriod
...
var TableCollection = {
    ...
    Search: function () {
        ...
        var tblSummaryData = $("#tblSummaryDataCollection").DataTable({
            ...
            "ajax": {
                "url": "/api/ApprovalARMonitoringBuilding/gridByCollection",
                "type": "POST",
                "datatype": "json",
                "data": params,
            },
            ...
            "columns": [
                {
                    ...
                    mRender: function (data, type, full) {
                        ...
                        if (Helper.IsElementExistsInArrayCollection(parseInt(full.trxInvoiceHeaderID), parseInt(full.mstInvoiceCategoryId), parseInt(full.BatchNumber), parseInt(full.mstPaymentCodeId), Data.RowSelectedCollection)) {
                            ...
                            strReturn += "<label id='" + full.mstInvoiceCategoryId + "-" + full.trxInvoiceHeaderID + "-" + full.BatchNumber + "-" + full.mstPaymentCodeId + "' class='mt-checkbox mt-checkbox-single mt-checkbox-outline " + full.mstInvoiceCategoryId + "-" + full.trxInvoiceHeaderID + "-" + full.BatchNumber + "'><input type='checkbox' checked class='checkboxes' /><span></span></label>";
                        }
                        else {
                            strReturn += "<label id='" + full.mstInvoiceCategoryId + "-" + full.trxInvoiceHeaderID + "-" + full.BatchNumber + "-" + full.mstPaymentCodeId + "' class='mt-checkbox mt-checkbox-single mt-checkbox-outline " + full.mstInvoiceCategoryId + "-" + full.trxInvoiceHeaderID + "-" + full.BatchNumber + "'><input type='checkbox' class='checkboxes' /><span></span></label>";
                        }
                        return strReturn;
                    }
                },
    ...
    Export: function () {
        ...
        window.location.href = "/InvoiceTransaction/TrxApprovalARMonitoringBuildingCollection/Export?strStartPeriod=" + strStartPeriod + "&strEndPeriod=" + strEndPeriod
...
var Process = {
    GenerateToCollection: function () {
        ...
        $.ajax({
            url: "/api/ApprovalARMonitoringBuilding/GenerateToCollection",
            type: "POST",
            dataType: "json",
            async: false,
    ...
    GenerateToAX: function () {
        ...
        $.ajax({
            url: "/api/ApprovalARMonitoringBuilding/GenerateToAX",
            type: "POST",
            dataType: "json",
            async: false,
            contentType: "application/json",
    ...
    ReOpen: function (HeaderId, CategoryId) {
        ...
        $.ajax({
            url: "/api/ApprovalARMonitoringBuilding/ReOpenInvoice",
            type: "POST",
            dataType: "json",
            contentType: "application/json",
            data: JSON.stringify(params),
    ...
    GenerateToExcel: function () {
        ...
        window.location.href = "/InvoiceTransaction/TrxApprovalARMonitoringBuildingToExcel/Export?strHeaderId=" + HeaderId + "&strCategoryId=" + CategoryId
                            + "&strBatchNumber=" + BatchNumber + "&strPaymentCodeId=" + PaymentCodeId;
    },
    ReOpenToPayment: function (HeaderId) {
        ...
        $.ajax({
            url: "/api/ApprovalARMonitoringBuilding/ReOpenInvoiceToPayment",
            type: "POST",
            dataType: "json",
            contentType: "application/json",
            data: JSON.stringify(params),
...
var Helper = {
    ...
    CalculateTotalAmountPaid: function () {
        ...
        $.ajax({
            url: "/api/ApprovalARMonitoringBuilding/GetPaidAmount",
            type: "POST",
            dataType: "json",
            async: false,
            contentType: "application/json",
            ...
            if (Common.CheckError.List(data)) {
                $("#tbTotalPaidAmount").val(Common.Format.CommaSeparation(data));
            }
        })
        .fail(function (jqXHR, textStatus, errorThrown) {
            Common.Alert.Error(errorThrown)
    ...
    GetListId: function (isCollection) {
        ...
        var AjaxData = [];
        $.ajax({
            url: "/api/ApprovalARMonitoringBuilding/GetListId",
            type: "POST",
            dataType: "json",
            async: false,
            contentType: "application/json",
