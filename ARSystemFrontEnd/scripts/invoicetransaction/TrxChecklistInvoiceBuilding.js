...
jQuery(document).ready(function () {
    ...
    $("#btSaveTaxInvoiceNo").unbind().on("click", function (e) {
        if ($("#formEditInvoiceNo").parsley().validate())
            InvoiceBuilding.UpdateTaxInvoiceNo();
        e.preventDefault();
    });
...
var Form = {
    ...
    SelectedData: function () {
        ...
        $("#panelTransactionTitle").text("Checklist Building Invoice");
...
var Table = {
    ...
    Search: function () {
        ...
        var tblSummaryData = $("#tblSummaryData").DataTable({
            ...
            "ajax": {
                "url": "/api/ChecklistInvoiceBuilding/grid",
                "type": "POST",
                "datatype": "json",
                "data": params,
            },
        ...
        $("#tblSummaryData tbody").on("click", "button.btSelect", function (e) {
            ...
            var validationResult = Helper.ValidateChecklist(Data.Selected.trxInvoiceHeaderID);
    ...
    Export: function () {
        var href = "/InvoiceTransaction/TrxChecklistInvoiceBuilding/Export?companyName=" + fsCompanyName + "&invoiceTypeId=" + fsInvoiceTypeId + "&status=" + fsStatus + "&invNo=" + fsInvNo;
...
var InvoiceBuilding = {
    Checklist: function () {
        ...
        $.ajax({
            url: "/api/ChecklistInvoiceBuilding",
            type: "POST",
            dataType: "json",
    ...
    ChecklistCollection: function () {
        ...
        var l = Ladda.create(document.querySelector("#btSubmit"))
        $.ajax({
            url: "/api/ChecklistInvoiceBuilding/Collection",
            type: "POST",
            dataType: "json",
            contentType: "application/json",
            data: JSON.stringify(params),
    ...
    CNInvoice: function () {
        ...
        $.ajax({
            url: "/api/ChecklistInvoiceBuilding/CNInvoice",
            type: "POST",
            dataType: "json",
            contentType: "application/json",
            data: JSON.stringify(params),
    ...
    ApproveCNInvoice: function () {
        ...
        $.ajax({
            url: "/api/ChecklistInvoiceBuilding/ApproveCNInvoice",
            type: "POST",
            dataType: "json",
            contentType: "application/json",
            data: JSON.stringify(params),
    ...
    RejectCNInvoice: function () {
        ...
        $.ajax({
            url: "/api/ChecklistInvoiceBuilding/RejectCNInvoice",
            type: "POST",
            dataType: "json",
            contentType: "application/json",
            data: JSON.stringify(params),
...
var Helper = {
    ...
    ValidateChecklist: function (trxInvoiceHeaderID) {
        var Result = {};
        ...
        var l = Ladda.create(document.querySelector("#btSearch"));
        $.ajax({
            url: "/api/ChecklistInvoiceBuilding/GetValidateResultChecklist",
            type: "POST",
            dataType: "json",
            async: false,
            contentType: "application/json",
        ...
        $("#btSubmit").unbind().on("click", function (e) {
            if (role != Role.ARCollection) {
                if ($("#formTransaction").parsley().validate())
                    InvoiceBuilding.Checklist();
            } else {
                if ($("#formTransaction").parsley().validate())
                    InvoiceBuilding.ChecklistCollection();
            }
            e.preventDefault();
        });
    }
