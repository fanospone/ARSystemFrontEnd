...
var Table = {
    ...
    Search: function () {
        ...
        var tblSummaryData = $("#tblSummaryData").DataTable({
            ...
            "ajax": {
                "url": "/api/ManageMergedInvoiceDetailTower/grid",
                "type": "POST",
                "datatype": "json",
                "data": params,
            },
    ...
    Export: function () {
        window.location.href = "/InvoiceTransaction/TrxManageMergedInvoiceDetailTower/Export?operatorId=" + fsOperatorId + "&companyId=" + fsCompanyId + "&invNo=" + fsInvNo;
    }
}
