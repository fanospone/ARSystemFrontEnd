...
var Control = {
    ...
    SetParamHeader: function () {
        ...
        var AccrueType = $(':radio[name=status]:checked').val();
...
var Form = {
    ...
    Submit: function () {
        ...
        $.ajax({
            url: "/api/ReactiveStopAccrue/submitRequest",
            type: "POST",
            dataType: "json",
...
var Table = {
    ...
    LoadHeader: function () {
        ...
        $(id).DataTable({
            ...
            "ajax": {
                "url": "/api/ReactiveStopAccrue/RequestHeader",
                "type": "POST",
                "datatype": "json",
                "data": paramHeader,
            },
        ...
        $("#tblRequestHeader tbody").on("click", ".editRow", function (e) {
            {
                ...
                l.start();
                $.ajax({
                    url: "/api/ReactiveStopAccrue/EditHeader",
                    type: "GET",
                    dataType: "json",
                    async: false,
                    data: params,
    ...
    LoadDetail: function () {
        ...
        if (dataType == "new") {
            ...
            $.ajax({
                url: "/api/ReactiveStopAccrue/RequestDetail",
                type: "POST",
                dataType: "json",
                contentType: "application/json",
                data: JSON.stringify(params),
    ...
    DetailTable: function () {
        ...
        $("#tblRequestDetail").DataTable({
            ...
            "columnDefs": [{ "targets": [4, 15, 16, 17, 18, 19], "visible": false }, { "targets": [1, 2, 3, 5, 6, 7, 8, 9, 10, 11, 12], "class": "text-center" }, { "targets": [13, 14], "class": "text-right" }],
            "fnDrawCallback": function () {
                if (dataType == "new") {
                    $(".btnExportDetail").hide();
                } else {
    ...
    ExportHeader: function () {
        window.location.href = "/ReactiveStopAccrue/exportRequestHeader?" + $.param(paramHeader);
    },
