...
{
	public class TrxARReOpenPaymentDateDetailRepository : BaseRepository<TrxARReOpenPaymentDateDetail>
	{
		private DbContext _context;
		public TrxARReOpenPaymentDateDetailRepository(DbContext context) : base(context)
		{
			_context = context;
		}
