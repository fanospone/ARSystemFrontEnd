...
{
	public class TrxARReOpenPaymentDateRepository : BaseRepository<TrxARReOpenPaymentDate>
	{
		private DbContext _context;
		public TrxARReOpenPaymentDateRepository(DbContext context) : base(context)
		{
			_context = context;
		}
		...
		private int pGetCount(string whereClause)
		{
			using (var command = _context.CreateCommand())
			{
				...
				command.CommandText = "dbo.uspTrxARReOpenPaymentDate";
