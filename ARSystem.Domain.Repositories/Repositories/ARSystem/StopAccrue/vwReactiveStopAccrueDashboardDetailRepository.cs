...
{
	public class vwReactiveStopAccrueDashboardDetailRepository : BaseRepository<vwReactiveStopAccrueDashboardDetail>
	{
		private DbContext _context;
		public vwReactiveStopAccrueDashboardDetailRepository(DbContext context) : base(context)
		{
			_context = context;
		}
		...
		public List<vwReactiveStopAccrueDashboardDetail> GetList(string whereClause = "", string orderBy = "")
		{
			return pGetList(whereClause, orderBy);
		}

		public List<vwReactiveStopAccrueDashboardDetail> GetPaged(string whereClause, string orderBy, int rowSkip, int pageSize)
		{
			return pGetPaged(whereClause, orderBy, rowSkip, pageSize);
		}

        public List<vwReactiveStopAccrueDashboardDetail> GetListdashboardDetail(long? HeaderID, int rowSkip, int pageSize, string detailCase, string departName, string deptOrdetailcase, string requestNumber)
        {
            return pGetListDashboardDetail(HeaderID, rowSkip, pageSize, detailCase, departName, deptOrdetailcase, requestNumber);
        }

        public List<vwReactiveStopAccrueDashboardDetail> GetListExportAllDashboardDetail(string submissionDateFrom, string submissionDateTo, string directorateCode, string AccrueType, string listAppHeaderID, string Activity)
        {
        ...
        private int pGetCount(string whereClause)
		{
			using (var command = _context.CreateCommand())
			{
				...
				command.CommandText = "dbo.uspvwReactStopAccrueDashboardDetail";
		...
		private List<vwReactiveStopAccrueDashboardDetail> pGetList(string whereClause, string orderBy)
		{
			using (var command = _context.CreateCommand())
			{
				command.CommandType = CommandType.StoredProcedure;
		...
		private List<vwReactiveStopAccrueDashboardDetail> pGetPaged(string whereClause, string orderBy, int rowSkip, int pageSize)
		{
			using (var command = _context.CreateCommand())
			{
				command.CommandType = CommandType.StoredProcedure;
        ...
        private List<vwReactiveStopAccrueDashboardDetail> pGetListDashboardDetail(long? HeaderID, int rowSkip, int pageSize, string detailCase, string departName, string deptOrdetailcase, string requestNumber)
        {
            using (var command = _context.CreateCommand())
            {
                command.CommandType = CommandType.StoredProcedure;
        ...
        public List<vwReactiveStopAccrueDashboardDetail> pGetListExportAllDashboardDetail(string submissionDateFrom, string submissionDateTo, string directorateCode, string AccrueType, string listAppHeaderID, string Activity)
        {
