...
{
	public class dwhRAOutstandingTSELGenerateDetailRepository : BaseRepository<dwhRAOutstandingTSELGenerateDetail>
	{
		private DbContext _context;
		public dwhRAOutstandingTSELGenerateDetailRepository(DbContext context) : base(context)
		{
			_context = context;
		}
		...
		public dwhRAOutstandingTSELGenerateDetail Create(dwhRAOutstandingTSELGenerateDetail data)
		{
			return pCreate(data);
		}

		public List<dwhRAOutstandingTSELGenerateDetail> CreateBulky(List<dwhRAOutstandingTSELGenerateDetail> data)
		{
			return pCreateBulky(data);
		}

		public dwhRAOutstandingTSELGenerateDetail Update(dwhRAOutstandingTSELGenerateDetail data)
		{
			return pUpdate(data);
		}
		...
		private int pGetCount(string whereClause)
		{
			using (var command = _context.CreateCommand())
			{
				...
				command.CommandText = "dbo.uspdwhRAOutstandingTSELGenerateDetail";
		...
		private List<dwhRAOutstandingTSELGenerateDetail> pCreateBulky(List<dwhRAOutstandingTSELGenerateDetail> data)
		{
			using (var command = _context.CreateCommand())
			{
				string xml = Helper.XmlSerializer<List<dwhRAOutstandingTSELGenerateDetail>>(data);
		...
		private dwhRAOutstandingTSELGenerateDetail pUpdate(dwhRAOutstandingTSELGenerateDetail data)
		{
			using (var command = _context.CreateCommand())
			{
				string xml = Helper.XmlSerializer<dwhRAOutstandingTSELGenerateDetail>(data);
